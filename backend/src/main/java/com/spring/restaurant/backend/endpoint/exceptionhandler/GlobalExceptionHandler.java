package com.spring.restaurant.backend.endpoint.exceptionhandler;

import com.spring.restaurant.backend.exception.DependentDataException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNotValidationException(RuntimeException ex, WebRequest request) {
        LOGGER.warn(ex.getMessage());
        return handleExceptionInternal(ex, ex.getMessage(), new HttpHeaders(), HttpStatus.UNPROCESSABLE_ENTITY, request);
    }

    @ExceptionHandler(value = {DependentDataException.class})
    protected ResponseEntity<Object> handleDependentDataException(RuntimeException ex, WebRequest request) {
        LOGGER.warn(ex.getMessage());
