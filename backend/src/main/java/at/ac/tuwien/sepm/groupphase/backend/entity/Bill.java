...
public class Bill {
    ...
    public Bill(Long invoiceId, String pdf, LocalDateTime paidAt, double totalCost) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, invoiceId, pdf, paidAt, totalCost, reservationStartedAt, servedTables);
    }
